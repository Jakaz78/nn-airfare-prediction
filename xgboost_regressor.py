    ...
    def fit(self, X, y, eval_set=None, verbose=False):
        ...
        for i in range(self.n_estimators):
            ...
            if eval_set is not None:
                ...
                eval_tree_pred = tree.predict(eval_X)
...
class DecisionTree:
    ...
    def _build_tree(self, X, gradients, hessians, depth=0, feature_indices=None):
        ...
        if feature_indices is None:
            feature_indices = list(range(X.shape[1]))  # full feature indices
        ...
        # Find best split
        best_gain, best_feature, best_threshold, left_mask, right_mask = self._find_best_split(
